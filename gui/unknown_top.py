...
#    May 11, 2019 01:45:34 PM +0545  platform: Windows NT
...
def vp_start_gui():
    ...
    root = tk.Tk()
    unknown_top_support.set_Tk_var()
    top = Toplevel1 (root)
    unknown_top_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(root, *args, **kwargs):
    ...
    unknown_top_support.set_Tk_var()
    top = Toplevel1 (w)
    unknown_top_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.TRadiobutton1.configure(variable=unknown_top_support.selected)
        ...
        self.TRadiobutton2.place(relx=0.446, rely=0.783, relwidth=0.083
                , relheight=0.0, height=26)
        self.TRadiobutton2.configure(variable=unknown_top_support.selected)
        self.TRadiobutton2.configure(value="3")
        self.TRadiobutton2.configure(takefocus="")
        self.TRadiobutton2.configure(text='''15''')

        self.TRadiobutton3 = ttk.Radiobutton(top)
        self.TRadiobutton3.place(relx=0.297, rely=0.783, relwidth=0.083
                , relheight=0.0, height=26)
        self.TRadiobutton3.configure(variable=unknown_top_support.selected)
